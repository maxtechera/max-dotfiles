...
echo "4. Run: cd max-dotfiles && ./install-arch.sh"
echo "   (Robust installer with package verification and error handling)"
CHROOT_SCRIPT
...
echo "4. cd max-dotfiles && ./install-arch.sh"
echo "   (Robust installer with package verification and fallback methods)"